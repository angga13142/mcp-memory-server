...
check "docker-compose.monitoring.yml" "file" "CRITICAL"
echo ""

echo "═══ PHASE 4: BACKUP & RECOVERY ═══"
check "scripts/backup_prometheus_advanced.sh" "exec" "CRITICAL"
check "scripts/backup_grafana_advanced.sh" "exec" "CRITICAL"
check "scripts/backup_application.sh" "exec" "CRITICAL"
check "scripts/restore_prometheus.sh" "exec" "CRITICAL"
check "scripts/restore_grafana.sh" "exec" "CRITICAL"
check "scripts/restore_application.sh" "exec" "CRITICAL"
check "scripts/verify_recovery.sh" "exec" "CRITICAL"
...
check "scripts/run_load_tests.sh" "exec" "CRITICAL"
echo ""
...
check "scripts/run_ci_locally.sh" "exec" "CRITICAL"
echo ""

echo "═══ PHASE 5.4: DR DRILL ═══"
check "docs/disaster-recovery/dr-drill-plan.md" "file" "CRITICAL"
check "scripts/simulate_dr_drill.sh" "exec" "CRITICAL"
